...
const imageList = (car) => (<img src={car.map(carImage)} />)
...
const cars =
  [
    {
      image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRrJHvv6NNt5K0cxGc8wD0ZBBLN297D4AAui7DcXJPXdB9bbBa5'
      , nickname: 'bertha'
      , year: 2016
      , make: 'dodge'
      , model: 'challenger'
  ...
  toggleTab = () => {
    if (this.state.activeTab === 0) {
      return (
        <div>
          <h1>Log</h1>
          <h4>Cars Card Page</h4>
          {carNicknameList(cars)}
