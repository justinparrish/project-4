...
import './App.css'
import { Button, Card, CardActions, CardTitle, Content, Header, Navigation, Layout, Tabs, Tab } from 'react-mdl'
...
const carCard = (info) => (
  <Card shadow={0} style={{ width: '512px', margin: 'auto' }}>
    <CardTitle style={{ color: '#fff', height: '176px', background: `url(${info.image_url}) center / cover` }}>
      {info.nickname}
    </CardTitle>
    <CardActions border>
